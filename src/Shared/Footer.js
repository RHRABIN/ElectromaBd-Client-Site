        ...
        <div>
            <footer className="footer p-10 bg-base-200 text-base-content">
                <div>
                    ...
                    <a className="link link-hover hover:text-red-400">Branding</a>
                    <a className="link link-hover hover:text-red-400">Design</a>
                    <a className="link link-hover hover:text-red-400">Marketing</a>
                    <a className="link link-hover hover:text-red-400">Advertisement</a>
                </div>
                <div>
                    <span className="footer-title">Company</span>
                    <a className="link link-hover hover:text-red-400">About us</a>
                    <a className="link link-hover hover:text-red-400">Contact</a>
                    <a className="link link-hover hover:text-red-400">Jobs</a>
                    <a className="link link-hover hover:text-red-400">Press kit</a>
                </div>
                <div>
                    <span className="footer-title">Legal</span>
                    <a className="link link-hover hover:text-red-400">Terms of use</a>
                    <a className="link link-hover hover:text-red-400">Privacy policy</a>
                    <a className="link link-hover hover:text-red-400">Cookie policy</a>
                </div>
            </footer>
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p>ElectromaBd <br />Providing reliable tech since 2008</p>
                </div>
