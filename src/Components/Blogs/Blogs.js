...
const Blogs = () => {
    return (
        <div className='lg:px-20 px-4 mt-10'>
            ...
            <div className='mb-10'>
                <h1 className="font-bold text-xl text-center underline text-info">What are the different ways to manage a state in a React application?</h1>
            ...
            <div className='mb-10'>
                <h1 className="font-bold text-center underline text-xl text-secondary">How does work Prototypical inheritance in JavaScript?</h1>
                <p>
            ...
            <div>
                <h1 className="text-xl font-bold text-center underline text-orange-400">Why you do not set the state directly in React. For example, if you have const [products, setProducts] = useState([]). Why you do not set products = [...] instead, you use the setProducts?</h1>
                <p>
            ...
            <div>
                <h1 className="text-xl text-center font-bold underline text-red-400">What is a unit test? Why should write unit tests?</h1>
                <p>
